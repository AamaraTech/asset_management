...
export class CreateComponent {
  ...
  ngOnInit(): void {
    ...
    // this.getFormFields();
    // console.log("FORM_FIELDS :: ",this.formFields());

    this.tableField = this.getTableData(null);

    this.apiService
      .get(ServiceUrlConstants.PURCHASE_ORDER)
      .subscribe((res: any) => {
        if (res?.results) {
          this.poDropDownData.set(res?.results);
        }
      });
  ...
  getFormFields() {
    this.formFields.set({
      [PurchaseOrderEnum.source]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.po_no]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.po_date]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.vendor]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.poc_name]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.poc_phone]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.poc_email]: this.getBasicInput(
        this.translate,
        PurchaseOrderEnum.source,
        false,
        null,
      ...
      [PurchaseOrderEnum.bill_to_address1]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.bill_to_address2]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.bill_to_name]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.bill_to_tax_no]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.bill_to_country]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.bill_to_city]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.bill_to_zip_code]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.bill_to_state]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.ship_to_address1]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.ship_to_address2]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.ship_to_name]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.ship_to_tax_no]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.ship_to_country]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.ship_to_city]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.ship_to_zipcode]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.ship_to_state]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.vendor_quotation_no]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.quotation_date]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.delivery_terms]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.delivery_preference]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.payment_terms]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.purchase_order_items]: this.getBasicInput(
        this.translate,
        PurchaseOrderEnum.purchase_order_items,
        false,
        null,
        null
      ),
      [PurchaseOrderEnum.terms_conditions]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.note]: this.getBasicInput(
        this.translate,
      ...
      [PurchaseOrderEnum.payment_type]: this.getBasicInput(
        this.translate,
  ...
  saveForm() {
    this.apiService
      .post(ServiceUrlConstants.PURCHASE_ORDER, this.form.value)
      .subscribe((res) => {
  ...
  getTableData(dataSource) {
    return (
      new TableBuilder(this.translate, PurchaseOrderEnum.purchase_order_items)
        ...
        .getDatasource<Array<PurchaseOrderItem>>('id', [])
        .enableFooter(true)
  ...
  getBasicInput(translate, field, editable, data, defaulData) {
    return new InputField(translate, field, editable, data, defaulData)
      .addFieldWidth('32%')
      .variantType('basic')
      .validate(true)
      .toObject();
