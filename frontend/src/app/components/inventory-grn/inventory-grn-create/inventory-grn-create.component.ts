...
import {
  GrnItemEnum,
  InventoryGrnEnum,
} from 'src/app/core/shared/common/enum/inventory-grn.enum';
...
import {
  GrnItem,
  InventoryGrnModel,
} from 'src/app/core/shared/common/model/inventory-grn.model';
import { PurchaseOrderModel } from 'src/app/core/shared/common/model/purchase-order.model';
...
import { TableFieldComponent } from 'src/app/sanadi-library/dynamic-form-generator/fields/table-field/table-field.component';

@Component({
  selector: 'sanadi-inventory-grn-create',
  standalone: true,
  imports: [
  ...
  templateUrl: './inventory-grn-create.component.html',
  styleUrl: './inventory-grn-create.component.scss',
})
export class InventoryGrnCreateComponent extends FormFieldUtil {
  ...
  loadGrnFormData(): void {
    ...
    // this.inventoryService.getGrnData();
    this.tableField = this.inventoryService.getNewTableData();
  }

  saveForm() {
    this.inventoryService.saveGrn(this.form.value);
  }
